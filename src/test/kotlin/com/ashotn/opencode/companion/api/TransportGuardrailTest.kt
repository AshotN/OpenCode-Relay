...
class TransportGuardrailTest {
    ...
    fun `forbids direct transport usage outside api package`() {
        val sourceRoot = Paths.get("src/main/kotlin/com/ashotn/opencode/companion")
        ...
        assertTrue(
            violations.isEmpty(),
            "Transport usage is only allowed under com.ashotn.opencode.companion.api. Violations:\n${violations.joinToString("\n")}",
        )
    }
}
